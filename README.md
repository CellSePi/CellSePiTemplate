...
This template is based on the official [Flet](https://flet.dev) build 
[template](https://github.com/flet-dev/flet/tree/main/sdk/python/templates/build), 
licensed under the [Apache License 2.0](LICENSE).

### Modifications

This version has been modified to add native splash screen support for Windows, 
